...
//    self.remoteNameLabel.text = self.callSession.remoteName;
    [AVUser loadUserWithUserID:self.callSession.remoteName result:^(AVUser *user, NSError *error) {
        self.remoteNameLabel.text = user.username ;
    }];
...
{
    [self _stopRing];
    [[MAXCallManager sharedManager] answerCall:self.callSession.callId];
}
...
- (IBAction)rejectAction:(id)sender
{
    ...
    [[MAXCallManager sharedManager] hangupCallWithReason:EMCallEndReasonDecline];
}
...
- (IBAction)hangupAction:(id)sender
{
    ...
    [[MAXCallManager sharedManager] hangupCallWithReason:EMCallEndReasonHangup];
}
