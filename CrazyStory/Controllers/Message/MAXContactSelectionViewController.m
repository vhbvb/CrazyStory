//
//  MAXContactSelectionViewController.m
//  CrazyStory
//
...
@interface MAXContactSelectionViewController ()
...
@implementation MAXContactSelectionViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = [AVUser SyncLoadUserWithUserID:username].username;
    cell.username = [AVUser SyncLoadUserWithUserID:username].username;
...
- (void)reloadFooterView
{
    if (self.mulChoice) {
        ...
        if ([self.selectedContacts count] == 0) {
            ...
            [_doneButton setTitle:[NSString stringWithFormat:@"确定(%zd)", [self.selectedContacts count]] forState:UIControlStateNormal];
        }
    }
}
...
- (void)loadDataSource
{
    if (!_presetDataSource) {
        [SVProgressHUD showWithStatus:NSLocalizedString(@"loadData", @"Load data...")];
