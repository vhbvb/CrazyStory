//
//  MAXCreateGroupViewController.m
//  CrazyStory
//
...
#import "EMTextView.h"
@interface MAXCreateGroupViewController ()<UITextFieldDelegate, UITextViewDelegate, EMChooseViewDelegate>
...
@implementation MAXCreateGroupViewController
...
- (void)viewDidLoad
{
    ...
    [addButton setTitle:@"加入成员" forState:UIControlStateNormal];
...
- (BOOL)viewController:(EMChooseViewController *)viewController didFinishSelectedSources:(NSArray *)selectedSources
{
    ...
    if ([selectedSources count] > (maxUsersCount - 1)) {
        UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"群组最大人数限制" message:nil delegate:nil cancelButtonTitle:@"确定" otherButtonTitles:nil, nil];
        [alertView show];
...
//    }
    ...
    __weak MAXCreateGroupViewController *weakSelf = self;
...
//    
//    if (control.isOn) {
//        _groupTypeLabel.text = @"公开群";
//    }
//    else{
//        _groupTypeLabel.text = @"隐私群";
//    }
//}
...
- (void)addContacts:(id)sender
{
    if (self.textField.text.length == 0) {
        UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"提示" message:@"请输入组名" delegate:nil cancelButtonTitle:@"确定" otherButtonTitles:nil, nil];
        [alertView show];
        return;
    }
    ...
    MAXContactSelectionViewController *selectionController = [[MAXContactSelectionViewController alloc] init];
